                ...
                <div className="flex flex-wrap items-start gap-10 md:gap-15 xl:gap-35">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><Link href="/" className="hover:text-green-600 transition">Support</Link></li>
                            <li><Link href="/" className="hover:text-green-600 transition">Pricing</Link></li>
                            <li><Link href="/" className="hover:text-green-600 transition">Affiliate</Link></li>
                        </ul>
                    </div>
                    <div>
                        <p className="font-semibold text-gray-800">Resources</p>
                        <ul className="mt-2 space-y-2">
                            <li><Link href="/" className="hover:text-green-600 transition">Company</Link></li>
                            <li><Link href="/" className="hover:text-green-600 transition">Blogs</Link></li>
                            <li><Link href="/" className="hover:text-green-600 transition">Community</Link></li>
                            <li><Link href="/" className="hover:text-green-600 transition">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">We’re hiring!</span></Link></li>
                            <li><Link href="/" className="hover:text-green-600 transition">About</Link></li>
                        </ul>
                    </div>
                    <div>
                        <p className="font-semibold text-gray-800">Legal</p>
                        <ul className="mt-2 space-y-2">
                            <li><Link href="/" className="hover:text-green-600 transition">Privacy</Link></li>
                            <li><Link href="/" className="hover:text-green-600 transition">Terms</Link></li>
                        </ul>
                    </div>
                </div>
